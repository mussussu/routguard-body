...
export default function ExerciseIllustration({ type, size = 120 }) {
  ...
  switch(type){
    ...
    case "towel_row":
      return (<svg {...props}><Ground/><Post/>{Body(100,80,60,60)}{Limb(100,80,120,100)}{Limb(85,80,105,100)}{Body(60,60,40,50)}<line x1="40" y="50" x2="160" y="50" stroke="#d32f2f" strokeWidth="3"/>{Head(35,48)}</svg>);
    case "plank":
